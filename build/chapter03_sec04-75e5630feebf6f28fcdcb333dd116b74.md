...
:class: tip
:class: dropdown
Diese Musterlösung verwendet Python, aber auch Tabellenkalkulationssoftware wie
Excel, LibreOffice Calc oder Numbers kann verwendet werden.
``` python
...
die Abweichung von fast 2 mm ist für eine Kugelbahn-Simulation zu hoch.
```
````
