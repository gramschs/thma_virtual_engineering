...
In der Praxis unterscheidet man oft zwischen dem Digital Twin Prototype (DTP),
bei dem das digitale Modell existiert, bevor das physische Objekt gebaut wird,
und der Digital Twin Instance (DTI), bei der das Modell ein konkretes,
bereits existierendes Objekt über seinen gesamten Lebenszyklus begleitet.
