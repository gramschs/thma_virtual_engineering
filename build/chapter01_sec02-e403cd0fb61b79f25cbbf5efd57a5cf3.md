...
PrusaSlicer ist ein **Slicer** für den 3D-Druck. Er wandelt ein Mesh (z. B. eine
...
festgelegt. PrusaSlicer läuft auf Windows, Linux und macOS.
...
Andere gut geeignete Objekte sind z. B. ein Zahnrad, ein Motorblock-Ausschnitt,
eine alte Schraube oder ein Stein mit rauer Oberfläche.
````
...
(Meshroom, CloudCompare, PrusaSlicer und VPython) sind Open Source und kostenlos
