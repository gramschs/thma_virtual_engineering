...
```{figure} pics/chap06_punkt_zu_oberflaeche.svg
:alt: Zwei-Panel-Vergleich: links eine gestrichelte rote Linie vom Scan-Punkt P
  zum nächsten Vertex V3 (Abstand zum nächsten Vertex, falsch), rechts ein
  orangefarbenes Lot vom Scan-Punkt P auf die Kante des Referenz-Meshes mit
  Rechtwinkelsymbol am Fußpunkt (Punkt-zu-Oberfläche-Abstand, korrekt).
:align: center

Der Punkt-zu-Oberfläche-Abstand (rechts) ist der kürzeste senkrechte Abstand
vom Scan-Punkt $P$ zur nächstliegenden Dreiecksfläche, nicht der Abstand zum
nächsten diskreten Vertex (links).
