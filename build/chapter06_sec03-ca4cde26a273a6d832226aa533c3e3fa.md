...
sind, ist die Registration aus Kapitel 5 nicht korrekt abgeschlossen worden
und muss wiederholt werden, bevor wir fortfahren.

```{figure} pics/chap06_fig01_load_meshes.png
Beide registrierten Meshes der Kugelbahn im DB Tree von CloudCompare. Das
Soll-Mesh ist blau hervorgehoben, das Ist-Mesh grün. Im 3D Viewer liegen
beide nahezu deckungsgleich übereinander. (Quelle: eigene Darstellung;
...
```{dropdown} Video "Cloud to Mesh Distance in CloudCompare" von CloudCompare Official
...
| -------- | --------- | --------------- |
| Mean distance | Mittlere Abweichung | _(ablesen)_ |
| Std. dev. | Standardabweichung | _(ablesen)_ |
| Max distance | Maximale Abweichung | _(ablesen)_ |
...
fig = px.histogram(
    ...
    x="Abweichung_mm",
    nbins=120,
    title="Verteilung der Punkt-zu-Oberfläche-Abstände – Kugelbahn",
